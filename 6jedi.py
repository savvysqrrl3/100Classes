class Jedi(object):
	def __init__(self, name, lightsaber, force_sensitivity, allegiance, stealth=10, strength=20, damage=0, dark=False, suspicion=False, trust=True):
		self.name = name
	...
	def forceLift(self, item, location, height):
		# moves item to a new location, reduces weight value, lifts it to a specified height
		return self
